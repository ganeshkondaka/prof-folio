    ...
    return (
        <div className='flex flex-row justify-center items-center px-4 pt-8 pb-5 xl:pb-4 md:py-14 max-w-5xl w-auto'>
            ...
            <div className='w-auto'>
                <Image src="/ganesh.png" alt="Ganesh" width={150} height={150} className='aspect-square rounded-3xl border p-1 border-zinc-400 hover:scale-110 translate duration-200 ease-in-out' />
            </div>
        </div>
    )
}
